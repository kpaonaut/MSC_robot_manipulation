...
load('F:\WANGRUI\V4.0\data\Rope\Traj_Train_Straightening.mat'); % load the training data of trajectory
load('F:\WANGRUI\V4.0\data\Rope\Bullet_Train_Straightening0.mat'); % load the training data of rope
