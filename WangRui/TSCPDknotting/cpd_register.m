...
Transform.sigma2 = sigma2 * normal.xscale * normal.yscale; % added by Rui
...
switch lower(opt.method)
    ...
    case {'nonrigid','nonrigid_lowrank'}
            ...
            Transform.sigma2 = sigma2*normal.xscale * normal.yscale; % added by Rui Wang. Pass variance to function that calls cpd_register
        if opt.normalize,
             Transform.Y=T*normal.xscale+repmat(normal.xd,M,1);
        end 
