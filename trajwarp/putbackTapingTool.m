...
%       Motion for Putting Back Taping Tool
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Created by Te Tang, 09/28/2016       
%  MSC Lab, UC Berkeley
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function putbackTapingTool(TapingTool_T_W, opt, si)

ParamSgnID = si.ParamSgnID{opt.robot_idx};
wasStopped = tg_start_stop('start');
wasBrakeOff = brake_on_off(ParamSgnID, 'off');

TapingTool_T_W = TapingTool_T_W * transl(-0.047, 0, -0.037); % marker - hole offset;
TCP_Hole_W =  TapingTool_T_W*[[rotx(pi),zeros(3,1)];[0,0,0,1]];    % flip the y,z direction of tcp
