function IN_COL = distance_measure(cylin1,cylin2,MEASUREMENT)
% updated by Yongxiang Fan at 02162016
...
SAME_PLANE = ~any(vec2'*cross_mul((cylin1.p1-cylin1.p2),(cylin2.p1-cylin1.p1))>0.02);
if SAME_PLANE ==false
