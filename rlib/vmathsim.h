...
//void	vect_cross_qdv (Vect *r, Vect *a, Vect *b);
void	vect_dot (double *r, Vect *a, Vect *b);
void	vect_add (Vect *r, Vect *a, Vect *b);
//void	vect_add_qdv (Vect *r, Vect *a, Vect *b);
...
//void	mat_vect_mult_diag (Vect *r, double *m, Vect *v);
