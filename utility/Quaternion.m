%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Modified by Wenjie Chen, FANUC Corporation, 2016/07/08
% Modified interp and scale methods to use shorter distance between two quaternions.
% Put the path of this file above rvc toolbox to override the Quaternion there
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
classdef Quaternion
    ...
    methods
        ...
        % See also ctraj, Quaternion.scale.
            ...
            theta = acos(q1*q2');
            % reverse q2 to get the shorter distance (smaller theta) ------ Wenjie Chen, FANUC Corporation, 2016/07/08            
            if theta > pi/2,  q2 = -q2;  theta = acos(q1*q2');  end
            count = 1;
